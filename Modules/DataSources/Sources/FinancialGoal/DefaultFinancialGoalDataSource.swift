...
@Observable
public final class DefaultFinancialGoalDataSource: FinancialGoalDataSource {
    
    @MainActor
    public static let shared: FinancialGoalDataSource = AppConfiguration.isMockEnv ? MockFinancialGoalDataSource() : DefaultFinancialGoalDataSource()
...
public extension DefaultFinancialGoalDataSource {
