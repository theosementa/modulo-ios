//
//  MockFinancialGoalDataSource.swift
//  Stores
//
...
@Observable
public final class MockFinancialGoalDataSource: FinancialGoalDataSource {

    @MainActor public static let shared = MockFinancialGoalDataSource()
...
extension MockFinancialGoalDataSource {
